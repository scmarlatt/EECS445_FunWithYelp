...
def read_useful(num_each_review):
	reviews = {}
	reviews[1] = read_star_reviews("useful_reviews/one_stars.txt", num_each_review)
	reviews[2] = read_star_reviews("useful_reviews/two_stars.txt", num_each_review)
	reviews[3] = read_star_reviews("useful_reviews/three_stars.txt", num_each_review)
	reviews[4] = read_star_reviews("useful_reviews/four_stars.txt", num_each_review)
	reviews[5] = read_star_reviews("useful_reviews/five_stars.txt", num_each_review)
